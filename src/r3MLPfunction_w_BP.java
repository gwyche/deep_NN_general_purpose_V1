...
public class r3MLPfunction_w_BP {
    ...
    public static r3weights r3MLPfunction_w_BP(int layers, int goal, double learnrate, double bias, Object[] alldata_array, double axisRatio, int dataColumns)  {
            ...
            double[] inputarray = new double [(int)((dataColumns)  * axisRatio)];  //INPUTS
            ...
            do {
                ...
                for(int i = 0; i < dataColumns; i++) {
                	inputarray[i] = currentobject.getInternalArray()[i];
                }
                ...
                //System.out.println(inputarray[0]+""+inputarray[1]+""+inputarray[2]+""+inputarray[3]+""+inputarray[4]+""+inputarray[5]+""+inputarray[6]+""+inputarray[7]);
                //System.out.println(hotelement);
                //END FEED FORWARD//
